...
public interface AlumnoRepository 
	...
	/**
	 * Obtener todos los alumnos de un curso cuyo nombre se proporciona como argumento
	 * @return Lista de alumnos
	 */
	public List<Alumno> findByCursoNombreContainsIgnoreCaseOrderByApellido1Asc(String nombre);
}
