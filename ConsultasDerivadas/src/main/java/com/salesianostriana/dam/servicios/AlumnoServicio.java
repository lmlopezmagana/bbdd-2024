...
public class AlumnoServicio extends BaseService<Alumno, Long, AlumnoRepository>{
	...
	/**
	 * Devuelve los alumnos de un curso cuyo nombre se proporciona
	 * ordenados por apellidos
	 */
	public List<Alumno> alumnosDeUnCurso(String nombre) {
		return repositorio.findByCursoNombreContainsIgnoreCaseOrderByApellido1Asc(nombre);
	}
